...
export default function Home() {
    return (
        <div>
            ...
            />
            <div className="px-24 py-16"  data-custom-class="body">
                <div align="center" style={{ textAlign: "left" }}>
                    ...
                    >
                        ...
                        <bdt className="question">
                            <strong>December 21, 2023</strong>
                        </bdt>
                    </div>
            ...
            >
              ...
              >
                ...
                <bdt className="block-component" />{" "}
                  ...
                  >
                    <bdt className="question">Maryland</bdt>,{" "}
                ...
                <bdt className="block-component" />
                        ...
                        at <bdt className="question">415 Sugarberry Court</bdt>
                        <bdt className="block-component" />,{" "}
                        <bdt className="question">Edgewood</bdt>
            ...
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                <span style={{ color: "rgb(89, 89, 89)" }}>
                  <bdt className="block-component" />
                  <bdt className="block-component" />,{" "}
                    <bdt className="question">MD</bdt>
                  <bdt className="statement-end-if-in-editor" />
                  <bdt className="block-component" />
                  <bdt className="block-component" />{" "}
                    <bdt className="question">21040</bdt>
                  <bdt className="statement-end-if-in-editor" />
                </span>
              </span>
            </span>
        ...
        >
          ...
          the website{" "}
            ...
            <bdt className="question">
              <a
                  href="https://www.aptolearn.com"
                  target="_blank"
                  data-custom-class="link"
              >
                https://www.aptolearn.com
              </a>
            </bdt>
          </span>{" "}
        ...
        >
          ...
          phone at <bdt className="question">4433562470</bdt>, email at{" "}
            <bdt className="question">contact@aptolearn.com</bdt>
          <bdt className="block-component" />,
          <bdt className="statement-end-if-in-editor" /> or by mail to{" "}
            <bdt className="question">415 Sugarberry Court</bdt>
          <bdt className="block-component" />,{" "}
            <bdt className="question">Edgewood</bdt>
          <bdt className="block-component" />
          <bdt className="block-component" />,{" "}
        ...
        >
          ...
          <bdt className="statement-end-if-in-editor" />
          ), and <bdt className="question">AptoLearn</bdt>, concerning your
        ...
        >
          ...
          upon posting or notifying you by{" "}
            <bdt className="question">contact@aptolearn.com</bdt>, as stated in
        ...
        >
          ...
          please address your request to:{" "}
            <bdt className="question">contact@aptolearn.com</bdt>. If we ever
        ...
        >
          ...
          chosen payment provider for any such amounts upon placing your order.{" "}
            ...
            <bdt data-type="conditional-block">
              ...
              />
              <bdt data-type="body">
                If your order is subject to recurring charges, then you consent
        ...
        <span style={{ fontSize: 15 }}>
          ...
          <bdt className="block-component" /> or call us at{" "}
            <bdt className="question">4433562470</bdt>
          <bdt className="statement-end-if-in-editor" />.
          <bdt className="statement-end-if-in-editor" />
        </span>
                    </div>
        ...
        >
          ...
          organize
          <bdt className="statement-end-if-in-editor" /> a campaign encouraging
        ...
        >
          ...
          >
            ...
            right and <bdt className="block-component" />
            license
            <bdt className="statement-end-if-in-editor" /> to reproduce, modify,
      ...
      >
        ...
        "Third-Party Content"
        <bdt className="statement-end-if-in-editor" />
        ). Such <span style={{ fontSize: "14.6667px" }}>Third-Party</span>{" "}
          Websites and <span style={{ fontSize: "14.6667px" }}>Third-Party</span>{" "}
      ...
      >
        ...
        <strong>
          &nbsp;
            ...
            >
              <a
                  href="http://www.aptolearn.com/privacypolicy"
                  target="_blank"
                  data-custom-class="link"
              >
                http://www.aptolearn.com/privacypolicy
              </a>
            </bdt>
          </span>
        </strong>
      ...
      >
        ...
        Services.
        <bdt className="block-component" /> We will not be liable to you or any
      ...
      <span style={{ fontSize: 15 }}>
        ...
        <bdt className="statement-end-if-in-editor" />) shall be commenced or
        prosecuted in the
        <bdt className="block-component" /> state and federal courts
        <bdt className="statement-end-if-in-editor" /> located in
        <bdt className="block-component" />{" "}
          <bdt className="question">Harford County</bdt>,
        <bdt className="statement-end-if-in-editor" />{" "}
          <bdt className="block-component" />
        <bdt className="question">Maryland</bdt>
        <bdt className="statement-end-if-in-editor" />, and the Parties hereby
        consent to, and waive all <bdt className="block-component" />
        defenses
        ...
        excluded from these Legal Terms. <bdt className="block-component" />
      </span>
                    <bdt className="block-component" />
                </div>
                <div className="MsoNormal" style={{ lineHeight: "1.5", textAlign: "left" }}>
                ...
                FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO{" "}
                  ...
                  <bdt data-type="conditional-block">
                    ...
                    <bdt data-type="body">
                      ...
                      <bdt className="question">$100.00 USD</bdt>
                      <bdt className="statement-end-if-in-editor" />
                      <bdt className="block-component" />
                    </bdt>
                  </bdt>
      ...
      >
        ...
        made by any third party due to or arising out of:{" "}
          ...
          Services; (<span style={{ fontSize: "14.6667px" }}>2</span>) breach of
          these Legal Terms; (<span style={{ fontSize: "14.6667px" }}>3</span>)
          any breach of your representations and warranties set forth in these
          Legal Terms; (<span style={{ fontSize: "14.6667px" }}>4</span>) your
          violation of the rights of a third party, including but not limited to
          intellectual property rights; or (
          <span style={{ fontSize: "14.6667px" }}>5</span>) any overt harmful
        ...
        <strong>
          <bdt className="statement-end-if-in-editor">
            ...
            >
              <strong>
                <bdt className="block-component" />
                Phone: <bdt className="question">4433562470</bdt>
                <bdt className="statement-end-if-in-editor" />
              </strong>
            </span>
                            </strong>
